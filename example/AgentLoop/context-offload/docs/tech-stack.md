...
| Created | 2026-02-17 |
| Status | Confirmed |
| PRD Reference | docs/requirements/2026-02-17-context-offload-prd.md |

## 1. 项目概况

学习/实验用途的 TypeScript 模块，实现 Agent Loop 中的上下文卸载方法。项目规模小，单模块，无外部服务依赖。
...
单模块简化架构，仍遵循 core/infrastructure 分离原则：
